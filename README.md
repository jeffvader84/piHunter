 ...
 * Now follow sets 1,2,4-6 [here](https://arkime.com/faq#maxmind): then either copy your config file over to the Pi or edit the GeoIP.conf in this Git repo and add your AccountID and LicenseKey. 
